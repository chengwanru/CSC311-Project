...
All training scripts (train_softmax.py, naive_bayes.py, ensemble_*.py,
stacking_ensemble.py) import exclusively from this file and from each
other where model-specific logic is needed.
